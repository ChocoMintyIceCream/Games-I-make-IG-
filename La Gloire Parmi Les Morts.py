...
invent = ["\033[38;5;212mGrappling Hook\033[0m)","\033[38;2;135;62;35mMap of Switzerland\033[0m","\033[38;2;130;0;250mDried up viola flower\033[0m","\033[91mList of 14 names\033[0m"]
allies = ["Horse",]
outfit = "regular"
achieve = []
smkbmb = 5
    ...
    #yay first choice... Yuppie!
     ...
     while Q0 != "A" or Q0 !="B":
          if Q0 == "A":
               ...
               if con == "YES":
                    ...
                    print(space.center(100))
                    print(space.center(100))
                    medi("You approah the guards slowly...")
                    print("")
                    slow("And slowly...")
                    print("")
                    slow("And slowly...")
                    print("")
                    medi("Until you are face-to-face with them.")
                    print("")
                    write("The guards turn to look at each other and back at you.")
                    print("")
                    quick("\033[1mGuard\033[0m: Leave now, stranger, this area is off limits!")
                    print("")
                    write("You say nothing in return.")
                    print("")
                    quick("\033[1mGuard\033[0m: Didn't you hear me? Back away now or else!")
                    medi("Your hand reaches for the dagger at your side, you unsheathe it quickly and slash the guards neck.")
                    write("He grips the wound before falling over onto the ground.")
                    print("")
                    quick("You prepare to strike the second guard-")
                    print("")
                    medi("But he blocks your attack with his sword.")
                    medi("You back away and attempt to lunge at him.")
                    print("")
                    quick("But before you are able to stab him, he slashes your arm.")
                    medi("You wince, but continue to fight.")
                    quick("...")
                    quick("...")
                    quick("...!")
                    medi("You deliver the final blow by stabing him in the chest.")
                    print("")
               ...
               print(space.center(100))
               print(space.center(100))
               write("You retrieve and run to the nearest wall of the border.") 
               medi("You wind up the rope of the hook before throwing it over the border.") 
               medi("You begin to climb slowly, making sure to check your surroundings with every step. The coast seems clear... for now.")
               slow("...")
               slow("...")
               medi("...!")
               ...
               if Q1 == "A":
                    ...
                    print("")
                    medi("You finish climbing but are surprised to see more guards than you expected.")
                    ...
                    if Q2 == "A":
                         ...
                         medi("Unfortunately, it doesn't go off and the guards begin to approach you slowly.")
                         medi("You back away, raising your hands in surrender. You back way until your back touches a pillar.")
                         medi("You see a vision flash before your eyes:")
                         slow("It isn't positive...")
                         slow("...")
                         slow("...")
                         slow("...!")
                         write("Kust as the guards are only a few inches away from you the smoke bomb finally goes off.")
                         quick("You quickly run away and begin to descend into the country while the guards start coughing.")
                         print('')
                         ...
                         medi("It isn't positive...")
                         slow("...")
                         slow("...")
                         quick("...!")
                         quick('You hear the blast of muskets going off')
                         write("Suddendly, your entire body feels as if it were in flames.")
                         medi("You fall to your knees and onto the ground below; coughing up blood.")
                         slow("The world in front of you becomes a blur before being consumed by darkness...")
                         print(space.center(100))
                         print(space.center(100))
                         print(space.center(100))
                         ...
                         print(space.center(100))
                         print(space.center(100))
                         medi('After taking a small break, you resume your descend and successfully make it over the border.')
                         break
     ...
     if Q0 == "A":
        #LOL! Not Lazare aura farming during this moment...
          ...
          medi("You pour the remains of the bottle onto the wound, the burning suddendly doubles.")
          medi("You try to igonre the pain as you begin wrapping up the wound...")
          write("")
          ...
          print(space.center(100))
          write("You have lost an ally:")
          medi("\033[38;2;100;100;100mHorse\033[0m has been removed")
          print('')
          allies.remove("Horse")
          allies.append("None")
        ...
        #why would anyone do this to the poor horse! (I made this an option; why am I complaining???)
          ...
          medi("You rest against it, running your hands through the bark wishing it was the pelt of your horse.")
          slow("The poor thing...")
          write("...")
